...
- Keep custom-icon inputs and the save action accessible when the mobile keyboard reduces the available height.

## [0.1.3] - 2026-09-10

- Prefer declared SVG and higher-resolution website icons over low-resolution favicon fallbacks.
